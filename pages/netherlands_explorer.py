# pages/netherlands_explorer.py - Netherlands Explorer Page
...
# Dataset - Update path to Netherlands data
df = pd.read_csv("data/netherlands/NL_ParametricStudy_11052025_Ataberk.csv")

# Select only the required columns
required_columns = ['Version', 'window_u', 'shgc', 'roof_u', 'extWall_u', 'transmittance', 'total_idealHeating', 'total_idealCooling']
# Add total_solarRad if it exists for compatibility
...
# Add co2 column if it doesn't exist (set to 0 for now)
...
def create_scatter_figure_netherlands(option_key):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#FFFFFF",
        font_color="#2C3E50",
        uirevision='net-scatter-plot'
    )
    return fig

def create_enhanced_modal_netherlands():
    return html.Div([
        html.Div(
            id="net-image-modal", 
            className="modal", 
            ...
            children=[
                html.Div([
                    html.Button("×", id="net-modal-close", className="modal-close"),
        ...
        dcc.Store(id="net-current-image-index", data=0),
        
        dcc.Input(
            id="net-keyboard-listener",
...
fig_scatter = create_scatter_figure_netherlands(initial_scatter_option)
...
filter_modal = dbc.Modal([
    ...
    dbc.ModalBody(
        html.Div(id="net-filter-modal-body"),
        style={"padding": "20px"}
    ),
    dbc.ModalFooter([
        dbc.Button(
            "Cancel",
            id="net-add-filter-cancel",
            className="me-2",
            style={
...
], id="net-add-filter-modal", size="md", is_open=False)

layout = dbc.Container([
    
    # Instance Comparison Section
    dbc.Row([
        # Left card: Instance Selection
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    html.Div([
                        html.Div(
                            id="net-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="net-virtual-scroll-container",
                    ...
                    dcc.Store(id="net-comparison-selected-instances-store", data=[]),
                    dcc.Store(id="net-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="net-virtual-scroll-position", data=0),
                    dcc.Store(id="net-virtual-item-height", data=40),
                    dcc.Store(id="net-virtual-container-height", data=320),
                    dcc.Store(id="net-selected-instances-store", data=[]),
                    dcc.Store(id="net-dropdown-open-state", data=False),
                    ...
                    dbc.Row([
                        ...
                        html.Div(id="net-dummy-search-output", style={"display": "none"}),
                        html.Div(id="net-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="net-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="net-search-input-container",
                        className="search-input-container hidden"
                    ),

                    dcc.Store(id="net-search-toggle-state", data=False),
                    ...
                    html.Div(id='net-instance-parameters', style={"marginTop": "8px"})
        ...
        # Right card: Instance Comparison
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="net-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    html.Iframe(src="https://omurbugra.github.io/Graph3dv5/",
                                style={"width": "100%", "height": "100%", "min-height": "400px", "border": "none"}),
                    id="net-model3d-card", style=CARDBODY_STYLE_NO_TOP_PADDING
                )
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='net-comparison-graph', style={"height": "100%", "min-height": "400px"}),
                    style=CARDBODY_STYLE_NO_TOP_PADDING
                )
            ], id="net-comparison-graph-card", style=CARD_STYLE, className="h-100")
        ], width=8)
    ], className="mb-4 align-items-stretch"),
    ...
    dbc.Row([
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="net-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="net-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
    ...
    html.Div([
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/netherlands/plot_extWall_u.png",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/netherlands/plot_window_u.png",
                    className="figure-img",
                    id="net-plot-window-u",
                    style={
                        "width": "90%",
                        "height": "auto",
                        "cursor": "pointer",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/netherlands/plot_shgc.png",
                    className="figure-img",
                    id="net-plot-window-shgc",
                    style={
                        "width": "90%",
                        "height": "auto",
                        "cursor": "pointer",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/netherlands/plot_roof_u.png",
                    className="figure-img",
                    id="net-plot-roof-u",
                    style={
                        "width": "90%",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/netherlands/plot_transmittance.png",
                    className="figure-img",
                    id="net-plot-transmittance",
                    style={
                        "width": "90%",
                        "height": "auto",
                        "cursor": "pointer",
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="net-instance-table-card", children=[
                dbc.CardHeader([
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="net-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Div([
                                                ...
                                                html.Div([
                                                    ...
                                                    id={"type": "net-param-selector", "param": "instance_name"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "transmittance"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "window_shgc"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "wall_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "window_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "roof_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "heating_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "net-param-selector", "param": "cooling_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                            ...
                                            ], id="net-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="net-filter-step-2", style={"display": "none"})
                                            
                                        ], id="net-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        dcc.Store(id="net-filter-dropdown-open", data=False),
                                        dcc.Store(id="net-filter-current-step", data=1),
                                        dcc.Store(id="net-filter-selected-param", data=None)
                                        
                                    ], style={"position": "relative", "display": "inline-block"})
                                ], width="auto"),
                                
                                dbc.Col(dbc.Input(
                                    id="net-table-search-input",
                                ...
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Span(id="net-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="net-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="net-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
    ...
    dcc.Store(id="net-table-selected-instances", data=[]),
    dcc.Store(id="net-table-filters", data={}),
    dcc.Download(id="net-download-instances"),

    create_enhanced_modal_netherlands(),

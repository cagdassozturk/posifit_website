# pages/spain_explorer.py - Spain Explorer Page
...
# Dataset - Update path to Spain data
df = pd.read_csv("data/spain/SPA_ParametricStudy_11042025_Ataberk_MLP.csv")
...
def create_scatter_figure_spain(option_key):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#FFFFFF",
        font_color="#2C3E50",
        uirevision='spa-scatter-plot'
    )
    return fig

def create_enhanced_modal_spain():
    return html.Div([
        html.Div(
            id="spa-image-modal", 
            className="modal", 
            ...
            children=[
                html.Div([
                    html.Button("×", id="spa-modal-close", className="modal-close"),
        ...
        dcc.Store(id="spa-current-image-index", data=0),
        
        dcc.Input(
            id="spa-keyboard-listener",
...
fig_scatter = create_scatter_figure_spain(initial_scatter_option)
...
filter_modal = dbc.Modal([
    ...
    dbc.ModalBody(
        html.Div(id="spa-filter-modal-body"),
        style={"padding": "20px"}
    ),
    dbc.ModalFooter([
        dbc.Button(
            "Cancel",
            id="spa-add-filter-cancel",
            className="me-2",
            style={
...
], id="spa-add-filter-modal", size="md", is_open=False)
...
layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    html.Div([
                        html.Div(
                            id="spa-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="spa-virtual-scroll-container",
                    ...
                    dcc.Store(id="spa-comparison-selected-instances-store", data=[]),
                    dcc.Store(id="spa-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="spa-virtual-scroll-position", data=0),
                    dcc.Store(id="spa-virtual-item-height", data=40),
                    dcc.Store(id="spa-virtual-container-height", data=320),
                    dcc.Store(id="spa-selected-instances-store", data=[]),
                    dcc.Store(id="spa-dropdown-open-state", data=False),
                    ...
                    dbc.Row([
                        ...
                        html.Div(id="spa-dummy-search-output", style={"display": "none"}),
                        html.Div(id="spa-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="spa-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="spa-search-input-container",
                        className="search-input-container hidden"
                    ),

                    dcc.Store(id="spa-search-toggle-state", data=False),
                    ...
                    html.Div(id='spa-instance-parameters', style={"marginTop": "8px"})
        ...
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="spa-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    ...
                    id="spa-model3d-card", style=CARDBODY_STYLE_NO_TOP_PADDING
                )
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='spa-comparison-graph', style={"height": "100%", "min-height": "400px"}),
                    style=CARDBODY_STYLE_NO_TOP_PADDING
                )
            ], id="spa-comparison-graph-card", style=CARD_STYLE, className="h-100")
        ], width=8)
    ], className="mb-4 align-items-stretch"),
    ...
    dbc.Row([
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="spa-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="spa-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
    ...
    html.Div([
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/spain/plot_extWall_u.png",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/spain/plot_window_u.png",
                    className="figure-img",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/spain/plot_shgc.png",
                    className="figure-img",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/spain/plot_roof_u.png",
                    className="figure-img",
                    id="spa-plot-roof-u",
                    style={
                        "width": "90%",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/spain/plot_transmittance.png",
                    className="figure-img",
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="spa-instance-table-card", children=[
                dbc.CardHeader([
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="spa-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Div([
                                                ...
                                                html.Div([
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "instance_name"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "transmittance"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "window_shgc"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "wall_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "window_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "roof_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "heating_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "spa-param-selector", "param": "cooling_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                            ...
                                            ], id="spa-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="spa-filter-step-2", style={"display": "none"})
                                            
                                        ], id="spa-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        dcc.Store(id="spa-filter-dropdown-open", data=False),
                                        dcc.Store(id="spa-filter-current-step", data=1),
                                        dcc.Store(id="spa-filter-selected-param", data=None)
                                        
                                    ], style={"position": "relative", "display": "inline-block"})
                                ], width="auto"),
                                
                                dbc.Col(dbc.Input(
                                    id="spa-table-search-input",
                                ...
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Span(id="spa-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="spa-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="spa-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
    ...
    dcc.Store(id="spa-table-selected-instances", data=[]),
    dcc.Store(id="spa-table-filters", data={}),
    dcc.Download(id="spa-download-instances"),

    create_enhanced_modal_spain(),

# pages/optimized.py - Güncellenmiş versiyon başlangıcı
...
#dataset
# Use proper separator; optimized CSV appears to be semicolon-delimited
df = pd.read_csv("data/pareto_front_predicted_100_yeni.csv", sep=';')
...
# Prefer a numeric column for color; fallback to last numeric column
...
if color_col is None:
    ...
    if len(numeric_cols) > 0:
        ...
        # As a last resort, coerce a known column to numeric
...
def create_scatter_figure(option_key):
    ...
    # Label sütunu ekle - Optimized için farklı mapping
    ...
    return html.Div([
        ...
        html.Div(
            ...
            children=[
                html.Div([
                    # Close button
                    html.Button("×", id="opt-modal-close", className="modal-close"),
        ...
        dcc.Store(id="opt-current-image-index", data=0),
        
        # Hidden input for keyboard events
        dcc.Input(
            id="opt-keyboard-listener",
...
layout = dbc.Container([
    ...
    dbc.Row([
            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    html.Div([
                        ...
                        html.Div(
                            id="opt-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="opt-virtual-scroll-container",
                    ...
                    dcc.Store(id="opt-comparison-selected-instances-store", data=[]),
                    # Store'lar - Performance için optimize edildi
                    dcc.Store(id="opt-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="opt-virtual-scroll-position", data=0),
                    dcc.Store(id="opt-virtual-item-height", data=40),
                    dcc.Store(id="opt-virtual-container-height", data=320),  # 400'den 360'a güncellendi
                    dcc.Store(id="opt-selected-instances-store", data=[]),
                    dcc.Store(id="opt-dropdown-open-state", data=False),
                    ...
                    dbc.Row([
                        ...
                        html.Div(id="opt-dummy-search-output", style={"display": "none"}),
                        html.Div(id="opt-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="opt-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="opt-search-input-container",
                        className="search-input-container hidden"
                    ),

                    # Arama durumu store'u
                    dcc.Store(id="opt-search-toggle-state", data=False),
                    ...
                    html.Div(id='opt-instance-parameters', style={"marginTop": "8px"})
        ...
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="opt-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='opt-comparison-graph', style={"height": "100%", "min-height": "400px"}),
    ...
    dbc.Row([
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="opt-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="opt-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
            ...
            dbc.Card(id="instance-table-card", children=[
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="opt-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                ...
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            ...
                                            ], id="opt-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="opt-filter-step-2", style={"display": "none"})
                                            
                                        ], id="opt-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        # Stores
                                        dcc.Store(id="opt-filter-dropdown-open", data=False),
                                        dcc.Store(id="opt-filter-current-step", data=1),
                                        dcc.Store(id="opt-filter-selected-param", data=None)
                                ...
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Span(id="opt-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="opt-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                ...
                dbc.CardBody([
                    ...
                    dash_table.DataTable(
                        ...
                        # optimized.py dosyasındaki DataTable'ın style_data_conditional kısmını bu şekilde güncelleyin:

                        # Data conditional styling - BASELINE ve diğer stil kuralları
                        style_data_conditional=[
                            # BASELINE ROW - TÜM HÜCRE İÇİN BOLD + MAVİ ARKA PLAN
                            {
                                'if': {
                                    'filter_query': '{instance_name} = Baseline'
                                },
                                'backgroundColor': '#E3F2FD',
                                'fontWeight': 'bold',  # BASELINE İÇİN BOLD EKLENDI
                                'color': '#2AACFD'
                            },
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="opt-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
    ...
    dcc.Store(id="opt-table-selected-instances", data=[]),
    dcc.Store(id="opt-table-filters", data={}),
    dcc.Download(id="opt-download-instances"),

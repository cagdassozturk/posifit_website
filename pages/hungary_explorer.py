# pages/hungary_explorer.py - Hungary Explorer Page
...
# Dataset - Update path to Hungary data
df = pd.read_csv("data/hungary/HUN_ParametricStudy_10312025_Ataberk_MLP.csv")
...
def create_scatter_figure_hungary(option_key):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#FFFFFF",
        font_color="#2C3E50",
        uirevision='hun-scatter-plot'
    )
    return fig

def create_enhanced_modal_hungary():
    return html.Div([
        html.Div(
            id="hun-image-modal", 
            className="modal", 
            ...
            children=[
                html.Div([
                    html.Button("×", id="hun-modal-close", className="modal-close"),
        ...
        dcc.Store(id="hun-current-image-index", data=0),
        
        dcc.Input(
            id="hun-keyboard-listener",
...
fig_scatter = create_scatter_figure_hungary(initial_scatter_option)
...
filter_modal = dbc.Modal([
    ...
    dbc.ModalBody(
        html.Div(id="hun-filter-modal-body"),
        style={"padding": "20px"}
    ),
    dbc.ModalFooter([
        dbc.Button(
            "Cancel",
            id="hun-add-filter-cancel",
            className="me-2",
            style={
...
], id="hun-add-filter-modal", size="md", is_open=False)
...
layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    html.Div([
                        html.Div(
                            id="hun-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="hun-virtual-scroll-container",
                    ...
                    dcc.Store(id="hun-comparison-selected-instances-store", data=[]),
                    dcc.Store(id="hun-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="hun-virtual-scroll-position", data=0),
                    dcc.Store(id="hun-virtual-item-height", data=40),
                    dcc.Store(id="hun-virtual-container-height", data=320),
                    dcc.Store(id="hun-selected-instances-store", data=[]),
                    dcc.Store(id="hun-dropdown-open-state", data=False),
                    ...
                    dbc.Row([
                        ...
                        html.Div(id="hun-dummy-search-output", style={"display": "none"}),
                        html.Div(id="hun-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="hun-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="hun-search-input-container",
                        className="search-input-container hidden"
                    ),

                    dcc.Store(id="hun-search-toggle-state", data=False),
                    ...
                    html.Div(id='hun-instance-parameters', style={"marginTop": "8px"})
        ...
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="hun-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    html.Iframe(src="https://omurbugra.github.io/Graph3dv6",
                                style={"width": "100%", "height": "100%", "min-height": "400px", "border": "none"}),
                    id="hun-model3d-card", style=CARDBODY_STYLE_NO_TOP_PADDING
                )
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='hun-comparison-graph', style={"height": "100%", "min-height": "400px"}),
                    style=CARDBODY_STYLE_NO_TOP_PADDING
                )
            ], id="hun-comparison-graph-card", style=CARD_STYLE, className="h-100")
        ], width=8)
    ], className="mb-4 align-items-stretch"),
    ...
    dbc.Row([
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="hun-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="hun-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
    ...
    html.Div([
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/hungary/plot_extWall_u.png",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/hungary/plot_window_u.png",
                    className="figure-img",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/hungary/plot_shgc.png",
                    className="figure-img",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/hungary/plot_roof_u.png",
                    className="figure-img",
                    id="hun-plot-roof-u",
                    style={
                        "width": "90%",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/hungary/plot_transmittance.png",
                    className="figure-img",
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="hun-instance-table-card", children=[
                dbc.CardHeader([
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="hun-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Div([
                                                ...
                                                html.Div([
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "instance_name"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "transmittance"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "window_shgc"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "wall_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "window_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "roof_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "heating_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-param-selector", "param": "cooling_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                            ...
                                            ], id="hun-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="hun-filter-step-2", style={"display": "none"})
                                            
                                        ], id="hun-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        dcc.Store(id="hun-filter-dropdown-open", data=False),
                                        dcc.Store(id="hun-filter-current-step", data=1),
                                        dcc.Store(id="hun-filter-selected-param", data=None)
                                        
                                    ], style={"position": "relative", "display": "inline-block"})
                                ], width="auto"),
                                
                                dbc.Col(dbc.Input(
                                    id="hun-table-search-input",
                                ...
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Span(id="hun-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="hun-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="hun-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
    ...
    dcc.Store(id="hun-table-selected-instances", data=[]),
    dcc.Store(id="hun-table-filters", data={}),
    dcc.Download(id="hun-download-instances"),

    create_enhanced_modal_hungary(),

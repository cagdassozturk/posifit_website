# pages/turkiye_optimized.py - Turkiye Optimized Page
...
# Dataset - Turkiye optimized data (comma-separated)
df = pd.read_csv("data/turkiye/TUR_pareto_optimized.csv")
...
def create_scatter_figure_turkiye_opt(option_key):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#FFFFFF",
        font_color="#2C3E50",
        uirevision='tur-opt-scatter-plot'
    )
    return fig

def create_enhanced_modal_turkiye_opt():
    return html.Div([
        html.Div(
            id="tur-opt-image-modal", 
            className="modal", 
            tabIndex=0, 
            style={"display": "none"},
            children=[
                html.Div([
                    html.Button("×", id="tur-opt-modal-close", className="modal-close"),
                    ...
                    html.Div([
                        html.Button(
                            ...
                            id="tur-opt-modal-prev", 
                            className="modal-nav-btn modal-prev"
                        ),
                        
                        html.Div([
                            html.Div(
                                id="tur-opt-modal-title",
        ...
        dcc.Store(id="tur-opt-current-image-index", data=0),
        
        dcc.Input(
            id="tur-opt-keyboard-listener",
...
fig_scatter = create_scatter_figure_turkiye_opt(initial_scatter_option)
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.Div([
                        html.Div(
                            id="tur-opt-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="tur-opt-virtual-scroll-container",
                    ...
                    dcc.Store(id="tur-opt-comparison-selected-instances-store", data=[]),
                    dcc.Store(id="tur-opt-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="tur-opt-virtual-scroll-position", data=0),
                    dcc.Store(id="tur-opt-virtual-item-height", data=40),
                    dcc.Store(id="tur-opt-virtual-container-height", data=320),
                    dcc.Store(id="tur-opt-selected-instances-store", data=[]),
                    dcc.Store(id="tur-opt-dropdown-open-state", data=False),
                    
                    dbc.Row([
                        dbc.Col(
                            html.Div([
                                dcc.Dropdown(
                                    id='tur-opt-sort-by-dropdown',
                                    options=[
                        ...
                        html.Div(id="tur-opt-dummy-search-output", style={"display": "none"}),
                        html.Div(id="tur-opt-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="tur-opt-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="tur-opt-search-input-container",
                        className="search-input-container hidden"
                    ),

                    dcc.Store(id="tur-opt-search-toggle-state", data=False),
                    ...
                    html.Div(id='tur-opt-instance-parameters', style={"marginTop": "8px"})
        ...
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="tur-opt-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    ...
                    id="tur-opt-model3d-card", style=CARDBODY_STYLE_NO_TOP_PADDING
                )
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='tur-opt-comparison-graph', style={"height": "100%", "min-height": "400px"}),
                    style=CARDBODY_STYLE_NO_TOP_PADDING
                )
            ], id="tur-opt-comparison-graph-card", style=CARD_STYLE, className="h-100")
        ], width=8)
    ], className="mb-4 align-items-stretch"),
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="tur-opt-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            dbc.Button(
                                ...
                                href="/pilot_tur_market_optimized",
                                external_link=True,
                                style={
                ...
                dbc.CardBody(
                    dcc.Graph(id="tur-opt-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="tur-opt-instance-table-card", children=[
                dbc.CardHeader([
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="tur-opt-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Div([
                                        html.Button(
                                            "Add Filter+",
                                            id="tur-opt-add-filter-trigger-btn",
                                        ...
                                        html.Div([
                                            html.Div([
                                                ...
                                                html.Div([
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "instance_name"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "transmittance"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "window_shgc"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "wall_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "window_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "roof_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "heating_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-opt-param-selector", "param": "cooling_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                            ...
                                            ], id="tur-opt-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="tur-opt-filter-step-2", style={"display": "none"})
                                            
                                        ], id="tur-opt-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        dcc.Store(id="tur-opt-filter-dropdown-open", data=False),
                                        dcc.Store(id="tur-opt-filter-current-step", data=1),
                                        dcc.Store(id="tur-opt-filter-selected-param", data=None)
                                        
                                    ], style={"position": "relative", "display": "inline-block"})
                                ], width="auto"),
                                
                                dbc.Col(dbc.Input(
                                    id="tur-opt-table-search-input",
                                ...
                                dbc.Col([
                                    html.Div([
                                        html.Button("««", 
                                                id="tur-opt-table-first-page-btn",
                                        ...
                                        html.Button("‹", 
                                                id="tur-opt-table-prev-page-btn",
                                        ...
                                        html.Div([
                                            html.Span(id="tur-opt-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="tur-opt-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                        ...
                                        html.Button("›", 
                                                id="tur-opt-table-next-page-btn",
                                        ...
                                        html.Button("»»", 
                                                id="tur-opt-table-last-page-btn",
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="tur-opt-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
                        ...
                        dbc.Col([
                            dbc.Button(
                                "Export Selected",
                                id="tur-opt-export-selected-btn",
                                size="sm",
                                style={
                                    "backgroundColor": "#2AACFD",
                                    "border": "none",
    ...
    dcc.Store(id="tur-opt-table-selected-instances", data=[]),
    dcc.Store(id="tur-opt-table-filters", data={}),
    dcc.Download(id="tur-opt-download-instances"),

    create_enhanced_modal_turkiye_opt(),

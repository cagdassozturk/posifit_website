# pages/hungary_optimized.py - Hungary Optimized Page
...
# Dataset - Hungary optimized data (comma-separated)
df = pd.read_csv("data/hungary/pareto_front_predicted_100_hun.csv")
...
def create_scatter_figure_hungary_opt(option_key):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#FFFFFF",
        font_color="#2C3E50",
        uirevision='hun-opt-scatter-plot'
    )
    return fig

def create_enhanced_modal_hungary_opt():
    return html.Div([
        html.Div(
            id="hun-opt-image-modal", 
            className="modal", 
            tabIndex=0, 
            style={"display": "none"},
            children=[
                html.Div([
                    html.Button("×", id="hun-opt-modal-close", className="modal-close"),
                    ...
                    html.Div([
                        html.Button(
                            ...
                            id="hun-opt-modal-prev", 
                            className="modal-nav-btn modal-prev"
                        ),
                        
                        html.Div([
                            html.Div(
                                id="hun-opt-modal-title",
        ...
        dcc.Store(id="hun-opt-current-image-index", data=0),
        
        dcc.Input(
            id="hun-opt-keyboard-listener",
...
fig_scatter = create_scatter_figure_hungary_opt(initial_scatter_option)
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.Div([
                        html.Div(
                            id="hun-opt-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="hun-opt-virtual-scroll-container",
                    ...
                    dcc.Store(id="hun-opt-comparison-selected-instances-store", data=[]),
                    dcc.Store(id="hun-opt-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="hun-opt-virtual-scroll-position", data=0),
                    dcc.Store(id="hun-opt-virtual-item-height", data=40),
                    dcc.Store(id="hun-opt-virtual-container-height", data=320),
                    dcc.Store(id="hun-opt-selected-instances-store", data=[]),
                    dcc.Store(id="hun-opt-dropdown-open-state", data=False),
                    
                    dbc.Row([
                        dbc.Col(
                            html.Div([
                                dcc.Dropdown(
                                    id='hun-opt-sort-by-dropdown',
                                    options=[
                        ...
                        html.Div(id="hun-opt-dummy-search-output", style={"display": "none"}),
                        html.Div(id="hun-opt-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="hun-opt-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="hun-opt-search-input-container",
                        className="search-input-container hidden"
                    ),

                    dcc.Store(id="hun-opt-search-toggle-state", data=False),
                    ...
                    html.Div(id='hun-opt-instance-parameters', style={"marginTop": "8px"})
        ...
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="hun-opt-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    ...
                    id="hun-opt-model3d-card", style=CARDBODY_STYLE_NO_TOP_PADDING
                )
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='hun-opt-comparison-graph', style={"height": "100%", "min-height": "400px"}),
                    style=CARDBODY_STYLE_NO_TOP_PADDING
                )
            ], id="hun-opt-comparison-graph-card", style=CARD_STYLE, className="h-100")
        ], width=8)
    ], className="mb-4 align-items-stretch"),
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="hun-opt-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="hun-opt-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="hun-opt-instance-table-card", children=[
                dbc.CardHeader([
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="hun-opt-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Div([
                                        html.Button(
                                            "Add Filter+",
                                            id="hun-opt-add-filter-trigger-btn",
                                        ...
                                        html.Div([
                                            html.Div([
                                                ...
                                                html.Div([
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "instance_name"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "transmittance"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "window_shgc"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "wall_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "window_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "roof_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "heating_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "hun-opt-param-selector", "param": "cooling_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                            ...
                                            ], id="hun-opt-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="hun-opt-filter-step-2", style={"display": "none"})
                                            
                                        ], id="hun-opt-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        dcc.Store(id="hun-opt-filter-dropdown-open", data=False),
                                        dcc.Store(id="hun-opt-filter-current-step", data=1),
                                        dcc.Store(id="hun-opt-filter-selected-param", data=None)
                                        
                                    ], style={"position": "relative", "display": "inline-block"})
                                ], width="auto"),
                                
                                dbc.Col(dbc.Input(
                                    id="hun-opt-table-search-input",
                                ...
                                dbc.Col([
                                    html.Div([
                                        html.Button("««", 
                                                id="hun-opt-table-first-page-btn",
                                        ...
                                        html.Button("‹", 
                                                id="hun-opt-table-prev-page-btn",
                                        ...
                                        html.Div([
                                            html.Span(id="hun-opt-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="hun-opt-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                        ...
                                        html.Button("›", 
                                                id="hun-opt-table-next-page-btn",
                                        ...
                                        html.Button("»»", 
                                                id="hun-opt-table-last-page-btn",
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="hun-opt-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
                        ...
                        dbc.Col([
                            dbc.Button(
                                "Export Selected",
                                id="hun-opt-export-selected-btn",
                                size="sm",
                                style={
                                    "backgroundColor": "#2AACFD",
                                    "border": "none",
    ...
    dcc.Store(id="hun-opt-table-selected-instances", data=[]),
    dcc.Store(id="hun-opt-table-filters", data={}),
    dcc.Download(id="hun-opt-download-instances"),

    create_enhanced_modal_hungary_opt(),

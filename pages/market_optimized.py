...
dash.register_page(__name__, path='/market-optimized')

# Load the dataset for plotting - OPTIMIZED VERSION USES DIFFERENT DATASET
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            html.H1(
                "Closest Market-Available Scenarios (Optimized)",
                style={
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    dcc.Graph(
                        id="market-optimized-scatter-plot",
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    dcc.Graph(
                        id="market-optimized-spider-chart",
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                ...
                dcc.Slider(
                    id="market-optimized-neighbors-slider",
                    min=1,
                    max=10,
                    step=1,
                    value=5,
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="market-optimized-instance-table-card", children=[
                dbc.CardHeader([
                ...
                dbc.CardBody([
                    ...
                    dash_table.DataTable(
                        id="market-optimized-instance-table",
                        columns=[
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="market-optimized-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
                        ...
                        dbc.Col([
                            dbc.Button(
                                "Export Selected",
                                id="export-market-optimized-button",
                                size="sm",
                                style={
    ...
    dcc.Store(id="market-optimized-selected-point-store", data=None),
    dcc.Store(id="market-optimized-instances-store", data=[]),
    
    # Store for table selection
    dcc.Store(id="market-optimized-table-selected-instances", data=[]),
    dcc.Download(id="market-optimized-download-instances"),
    
    # Store for layer descriptions data
    dcc.Store(id="market-optimized-layers-data", data={}),
    
    # Store for tracking hover state
    dcc.Store(id="market-optimized-hover-state", data={}),

# pages/turkiye_explorer.py - Turkiye Explorer Page
...
# Dataset - Update path to Turkiye data
df = pd.read_csv("data/turkiye/TUR_ParametricStudy_10292025.csv")
...
def create_scatter_figure_turkiye(option_key):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#FFFFFF",
        font_color="#2C3E50",
        uirevision='tur-scatter-plot'
    )
    return fig

def create_enhanced_modal_turkiye():
    return html.Div([
        html.Div(
            id="tur-image-modal", 
            className="modal", 
            ...
            children=[
                html.Div([
                    html.Button("×", id="tur-modal-close", className="modal-close"),
        ...
        dcc.Store(id="tur-current-image-index", data=0),
        
        dcc.Input(
            id="tur-keyboard-listener",
...
fig_scatter = create_scatter_figure_turkiye(initial_scatter_option)
...
filter_modal = dbc.Modal([
    ...
    dbc.ModalBody(
        html.Div(id="tur-filter-modal-body"),
        style={"padding": "20px"}
    ),
    dbc.ModalFooter([
        dbc.Button(
            "Cancel",
            id="tur-add-filter-cancel",
            className="me-2",
            style={
...
], id="tur-add-filter-modal", size="md", is_open=False)
...
layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    html.Div([
                        html.Div(
                            id="tur-virtual-dropdown-trigger",
                        ...
                        html.Div(
                            id="tur-virtual-scroll-container",
                    ...
                    dcc.Store(id="tur-comparison-selected-instances-store", data=[]),
                    dcc.Store(id="tur-selection-warning-state", data={"show": False, "message": ""}),
                    dcc.Store(id="tur-virtual-scroll-position", data=0),
                    dcc.Store(id="tur-virtual-item-height", data=40),
                    dcc.Store(id="tur-virtual-container-height", data=320),
                    dcc.Store(id="tur-selected-instances-store", data=[]),
                    dcc.Store(id="tur-dropdown-open-state", data=False),
                    ...
                    dbc.Row([
                        ...
                        html.Div(id="tur-dummy-search-output", style={"display": "none"}),
                        html.Div(id="tur-dummy-outside-click", style={"display": "none"}),
                        
                        dbc.Col(
                            dbc.Button(
                                "🔍",
                                id="tur-search-toggle-button",
                    ...
                    html.Div(
                        ...
                        id="tur-search-input-container",
                        className="search-input-container hidden"
                    ),

                    dcc.Store(id="tur-search-toggle-state", data=False),
                    ...
                    html.Div(id='tur-instance-parameters', style={"marginTop": "8px"})
        ...
        dbc.Col(
            dbc.Card(
                [
                    dbc.CardBody(
                        html.Div(id="tur-instance-comparison-content"),
                        style={
                            "paddingTop": "0px",
                            "paddingRight": "16px",
                            "paddingBottom": "16px",
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    html.Iframe(src="https://omurbugra.github.io/Graph3dv3",
                                style={"width": "100%", "height": "100%", "min-height": "400px", "border": "none"}),
                    id="tur-model3d-card", style=CARDBODY_STYLE_NO_TOP_PADDING
                )
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id='tur-comparison-graph', style={"height": "100%", "min-height": "400px"}),
                    style=CARDBODY_STYLE_NO_TOP_PADDING
                )
            ], id="tur-comparison-graph-card", style=CARD_STYLE, className="h-100")
        ], width=8)
    ], className="mb-4 align-items-stretch"),
    ...
    dbc.Row([
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="tur-parallel-plot", figure=fig_parallel),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
        ...
        dbc.Col(
            dbc.Card([
                ...
                dbc.CardBody(
                    dcc.Graph(id="tur-scatter-plot", figure=fig_scatter),
                    style={
                        "paddingTop": "0px",
                        "paddingRight": "16px",
                        "paddingBottom": "16px",
    ...
    html.Div([
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/turkiye/plot_extWall_u.png",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/turkiye/plot_window_u.png",
                    className="figure-img",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/turkiye/plot_shgc.png",
                    className="figure-img",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/turkiye/plot_roof_u.png",
                    className="figure-img",
                    id="tur-plot-roof-u",
                    style={
                        "width": "90%",
        ...
        html.Div([
            html.Div([
                ...
                html.Img(
                    src="/assets/turkiye/plot_transmittance.png",
                    className="figure-img",
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(id="tur-instance-table-card", children=[
                dbc.CardHeader([
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                html.Div(id="tur-filter-chips-container", children=[], style={
                                    "display": "inline-flex",
                                    "gap": "8px",
                                    "alignItems": "center",
                                    "flexWrap": "wrap",
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Div([
                                                ...
                                                html.Div([
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "instance_name"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "transmittance"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "window_shgc"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "wall_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "window_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "roof_u"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "heating_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                                    ...
                                                    id={"type": "tur-param-selector", "param": "cooling_load"},
                                                    style={
                                                        "display": "flex",
                                                        "alignItems": "center",
                                                        "justifyContent": "space-between",
                                            ...
                                            ], id="tur-filter-step-1", style={"display": "block"}),
                                            ...
                                            ], id="tur-filter-step-2", style={"display": "none"})
                                            
                                        ], id="tur-filter-dropdown-menu", className="filter-dropdown-menu", style={
                                            "display": "none",
                                            "position": "absolute",
                                            "top": "100%",
                                            "left": "0",
                                        ...
                                        dcc.Store(id="tur-filter-dropdown-open", data=False),
                                        dcc.Store(id="tur-filter-current-step", data=1),
                                        dcc.Store(id="tur-filter-selected-param", data=None)
                                        
                                    ], style={"position": "relative", "display": "inline-block"})
                                ], width="auto"),
                                
                                dbc.Col(dbc.Input(
                                    id="tur-table-search-input",
                                ...
                                dbc.Col([
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.Span(id="tur-table-current-page",
                                                    children="1",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                                            ...
                                            html.Span(id="tur-table-total-pages",
                                                    children="17",
                                                    style={
                                                        "fontFamily": "Poppins, sans-serif",
                                                        "fontSize": "14px",
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div(id="tur-table-info", style={
                                "fontSize": "12px",
                                "color": "#6C757D",
                                "padding": "8px 0"
                            })
    ...
    dcc.Store(id="tur-table-selected-instances", data=[]),
    dcc.Store(id="tur-table-filters", data={}),
    dcc.Download(id="tur-download-instances"),

    create_enhanced_modal_turkiye(),

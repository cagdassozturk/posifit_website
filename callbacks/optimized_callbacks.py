...
from pages.optimized import df, labels
...
@callback(
    [Output("opt-parallel-plot", "figure"),
     Output("opt-scatter-plot", "figure")],
    [Input("opt-scatter-plot", "clickData"),
     Input("opt-scatter-plot", "selectedData"),
     Input("opt-parallel-plot", "restyleData")],
    [State("opt-parallel-plot", "figure"),
     State("opt-scatter-plot", "figure")],
...
@callback(
    [Output("opt-image-modal", "style"),
     Output("opt-modal-image", "src"),
     Output("opt-modal-title", "children"),
     Output("opt-current-image-index", "data"),
     Output("opt-modal-prev", "disabled"),
     Output("opt-modal-next", "disabled")],
    [Input("opt-plot-wall-u", "n_clicks"),
     Input("opt-plot-window-u", "n_clicks"),
     Input("opt-plot-window-shgc", "n_clicks"),
     Input("opt-plot-roof-u", "n_clicks"),
     Input("opt-plot-transmittance", "n_clicks"),
     Input("opt-modal-close", "n_clicks"),
     Input("opt-modal-prev", "n_clicks"),
     Input("opt-modal-next", "n_clicks")],
    [State("opt-current-image-index", "data")],
    prevent_initial_call=True
)
...
# Klavye kontrolü için clientside callback (optimized-specific)
clientside_callback(
    """
    ...
    """,
    Output('opt-keyboard-listener', 'value'),
    Input('opt-image-modal', 'style'),
    prevent_initial_call=True
)
